...
import static Project.student.StudentRW.WriteStd;
...
public class AddStudent extends javax.swing.JFrame {
    ...
    if(isNull(name)||isNull(id)||isNull(pass)||isNull(email)||isNull(adress)||isNull(city)||isNull(contactno))
        empty=true;
    else if(Checkers.ContactNoValidation(contactno)&&Checkers.isValidId(id)&&Checkers.EmailValidation(email)&&!empty){
    WriteStd(name,false);
    WriteStd(id,false);
    WriteStd(pass,false);
    WriteStd(email,false);
    WriteStd(adress,false);
    WriteStd(city,false);
    WriteStd(contactno,false);
    WriteStd("0",false);
    WriteStd("0",true);
